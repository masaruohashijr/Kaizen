...
public class CentroCustoPage extends KaizenAbstractPage<CentroCusto> {
	...
	@Override
	protected void deleteObject(CentroCusto obj) throws Exception {
		CustosDataService.get().getCentroCustoDao().delete(obj);
	}

	@Override
	protected void insertObject(CentroCusto obj) throws Exception {
		CustosDataService.get().getCentroCustoDao().insert(obj);

	}

	@Override
	protected void updateObject(CentroCusto obj) throws Exception {
