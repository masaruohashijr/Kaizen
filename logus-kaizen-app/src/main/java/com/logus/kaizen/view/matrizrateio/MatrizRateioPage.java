...
public class MatrizRateioPage extends KaizenAbstractPage<MatrizRateio> {
	...
	@Override
	protected void deleteObject(MatrizRateio obj) throws Exception {
		CustosDataService.get().getMatrizRateioDao().delete(obj);
	}

	@Override
	protected void insertObject(MatrizRateio obj) throws Exception {
		CustosDataService.get().getMatrizRateioDao().insert(obj);

	}

	@Override
	protected void updateObject(MatrizRateio obj) throws Exception {
