...
public class ItemSolicitacaoEditWindow<T extends Object> extends Dialog {
	 ...
	 */
	private Collection<ItemSolicitacaoForm> forms;

	private ItemSolicitacaoForm form;
	 ...
	 */
	public ItemSolicitacaoEditWindow(String caption, ItemSolicitacaoForm form, DialogButtonType confirmButtonType,
			boolean readOnly) {
