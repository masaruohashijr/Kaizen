...
public class FuncionalidadePlano extends Funcionalidade {
	 ...
	 */
	public static final FuncionalidadePlano FUNC_PLANO_CADASTRAR = create("FUNC_PLANO_CADASTRAR","Cadastrar Plano de Integração de Builds");
	/**
	 * Consulta de planos de integração de builds.
	 */
	public static final FuncionalidadePlano FUNC_PLANO_CONSULTAR = create("FUNC_PLANO_CONSULTAR","Consultar Plano de Integração de Builds");
